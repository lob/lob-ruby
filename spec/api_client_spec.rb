...
describe Lob::ApiClient do
  ...
  describe 'params_encoding in #build_request' do
    let(:config) { Lob::Configuration.new }
    let(:api_client) { Lob::ApiClient.new(config) }

    it 'defaults to nil' do
      expect(Lob::Configuration.default.params_encoding).to eq(nil)
  ...
  describe 'timeout in #build_request' do
    ...
    it 'defaults to 0' do
      expect(Lob::Configuration.default.timeout).to eq(0)
  ...
  describe '#build_collection_param' do
    let(:param) { ['aa', 'bb', 'cc'] }
    let(:api_client) { Lob::ApiClient.new }
